...
![Cодержимое каталога](image/06.png){ #fig:006 width=70% }

Для данной задачи я создала файл prog2.sh и написала соответствующий скрипт. (рис. -@fig:007) 

![Второй скрипт](image/07.png){ #fig:007 width=70% }
...
![Третий скрипт](image/09.png){ #fig:009 width=70% }
...
![Проверка работы скрипта](image/10.png){ #fig:010 width=70% } 
